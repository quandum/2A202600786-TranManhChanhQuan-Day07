...
| ------------ | --------------------------------- | --------------------- | -------------------------------- | ------------------------------ |
| Tôi         | RecursiveChunker(300)             | 7                     | Tôn trọng cấu trúc văn bản | Chunk có thể không đều    |
| [Tên]       | SentenceChunker                   | 6                     | Câu hoàn chỉnh                | Chunk quá dài cho docs ngắn |
| [Tên]       | FixedSizeChunker(500, overlap=50) | 6                     | Đơn giản, đều đặn         | Cắt giữa câu                |

**Strategy nào tốt nhất cho domain này? Tại sao?**

> `RecursiveChunker` phù hợp nhất cho domain AI docs vì tài liệu Markdown có cấu trúc phân cấp rõ ràng. Strategy này giữ nguyên đoạn văn và tiêu đề liền mạch, tạo ra các chunk có ý nghĩa ngữ nghĩa cao hơn so với cắt cứng theo ký tự.
